  ...
  <div>
    ...
    <ul>
      <li>
        ...
        refers to Body Measurements.
      </li>
      <li><strong>Service</strong> refers to the Website.</li>
      <li>
        <strong>You</strong> means the individual accessing the Service, or the
        company, or other legal entity on behalf of which such individual is
        accessing or using the Service, as applicable.
      </li>
      <li>
        <strong>Website</strong> refers to Body Measurements, accessible from
        <a
          href="https://body-measurements.justine.kizhak.com/"
          rel="external nofollow noopener"
          target="_blank"
          >https://body-measurements.justine.kizhak.com/</a
        >
      </li>
    </ul>
    <h1>Disclaimer</h1>
    ...
    <p>
      ...
      be delays, omissions or inaccuracies in the information contained on the
      Service.
    </p>
    <p>
    ...
    <p>
      The Service may contain views and opinions which are those of the authors
      and do not necessarily reflect the official policy or position of any
      other author, agency, organization, employer or company, including the
      Company.
    </p>
    <p>
    ...
    <p>
      ...
      Company is not herein engaged in rendering legal, accounting, tax, or
      other professional advice and services. As such, it should not be used as
      a substitute for consultation with professional accounting, tax, legal or
    ...
    <p>
      ...
      or in connection with your access or use or inability to access or use the
      Service.
    </p>
    ...
    <ul>
      <li>By email: justine@kizhak.com</li>
    </ul>
  </div>
</template>
